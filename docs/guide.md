...
<p style="font-weight:black">お願い</p>
<p style="font-weight:black">現在、Windows版をご利用の一部の方から「5分間ほど使うとトラッキングが止まる」という報告を複数頂いています。無料トライアル版で動作確認される際には、5分以上経過してもトラッキングが止まらないことをご確認ください。お手数をおかけしますがご理解いただけますようお願いいたします。</p>
